...
- **13:30 PDT** | **Opt3 retrain submitted: grouped split + soft α=0.1 incl. benign** | Omar recipe; monitor pix / L_slide / L_grade separately (already in log) | Soft chain benign↔G3↔G4↔G5 @0.1; `n≥5` ISUP skip; `min_area_pct=0`. Tag `opt3_grouped_soft01_benign`. Job id in this bullet after sbatch. Live splits: 3739/472/472.
